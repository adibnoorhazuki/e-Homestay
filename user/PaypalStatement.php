			...
			<br/>
				<div class="container">	
					...
					<div class="form">
						<form id="PaypalStatement" action="" method="GET"> 
							<?php
								$sql1 = mysql_query("select * from reserve JOIN homestay ON reserve.homestay_reserve_id=homestay.homestay_id JOIN agent ON homestay.homestay_agent_id=agent.agent_id where reserve_id ='".$_SESSION['reserve_id']."'") or die(mysql_error());
								$data=mysql_fetch_assoc($sql1)
							?>
							<?php
								$sql2 = mysql_query("select * from reserve JOIN userinfo ON reserve.homestay_user_id=userinfo.user_id where reserve_id ='".$_SESSION['reserve_id']."'") or die(mysql_error());
							...
							<input type="hidden" name="reserve_id" value="<?php echo $_SESSION['reserve_id'];?>"> 
