				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!-- Trigger the Modal -->
								...
								<img id="myImg" src="../img/<?php echo $data['image'];?>" alt="img" width="300" height="200">
							...
							<div class="media-body">
								...
								<button onclick="location.href='reserve.php?search=<?php echo $data['homestay_id']; ?>'" class="homestayDetail">
