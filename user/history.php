				...
				<div class="jumbotron text-center">
						...
						<tr>
							<td height="32" align="center"><br />
								<form name="frm search" action="" method="POST">
									...
									<button action="history.php" method="POST">
									Search
									</button>
								</form>
							</td>
					...
					<table width="90%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#ffef99">
						<tr>
							...
							<th width="20%" align="center" bgcolor="#ffad33">
								<strong><center> Name </center></strong>
							</th>
							<th width="15%" align="center" bgcolor="#ffad33">
								<strong><center> Date Checked In </center></strong>
								<th width="10%" align="center" bgcolor="#ffad33">
								<strong><center> Reservation ID </center></strong>
							</th>
							<th width="10%" align="center" bgcolor="#ffad33">
								<strong><center> View Statement </center></strong>
							</th>
						</tr>
						
							<tr>
							<?php
								$sql1 = mysql_query("select * from userinfo JOIN reserve ON userinfo.user_id=reserve.homestay_user_id JOIN homestay ON reserve.homestay_reserve_id=homestay.homestay_id where homestay_user_id ='".$_SESSION['user_id']."'") or die(mysql_error());
								$no = 1;
								while($data=mysql_fetch_assoc($sql1)){
							?>
									<tr>
									<td align="center"><?php echo $no++; ?> </td>
									<td align="center"><?php echo $data['homestay_name']; ?></td>
									<td align="center"><?php echo $data['datepicker']; ?></td>
									<td align="center"><?php echo $data{'reserve_id'}; ?></td>
									<td><center>
									<button name="search" onclick="location.href='historyStatement.php?reserve_id=<?php echo $data['reserve_id'];?>'">STATEMENT</button> &nbsp;
									</center></td>
									</tr>
							<?php	
							}	
